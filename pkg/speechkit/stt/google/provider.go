...
// SetStreamingCredentialEnvs overrides the env-var names the streaming path
// reads the service-account JSON and the Application Default Credentials file
// from. Empty values keep the current names.
