...
func DefaultProviderProfiles() []ProviderProfile {
	return []ProviderProfile{
		...
		},
		{
			...
			Mode:           ModeDictation,
			Name:           "Universal (AssemblyAI)",
			ProviderKind:   ProviderKindDirectProvider,
			ExecutionMode:  ExecutionModeAssemblyAI,
			ModelID:        "universal-3-pro,universal-2",
			Source:         "AssemblyAI",
			Description:    "AssemblyAI Universal-3 pre-recorded + streaming transcription. High-accuracy general STT; the diarization variant adds speaker labels and content-based speaker identification by name/role.",
			License:        "proprietary",
			Capabilities:   []Capability{CapabilityTranscription, CapabilitySTT, CapabilityAudioInput},
		...
		},
		{
			...
			Mode:           ModeDictation,
			Name:           "Universal Diarization + Speaker Identification (AssemblyAI)",
			ProviderKind:   ProviderKindDirectProvider,
			ExecutionMode:  ExecutionModeAssemblyAI,
			ModelID:        "universal-3-pro,universal-2",
			Source:         "AssemblyAI",
			Description:    "AssemblyAI pre-recorded transcription with speaker_labels and optional content-based speaker identification by known names or roles.",
			License:        "proprietary",
		...
		},
		{
			...
			ProviderKind:   ProviderKindDirectProvider,
			ExecutionMode:  ExecutionModeDeepgram,
			ModelID:        "nova-3+aura-2",
			Source:         "Deepgram",
			Description:    "Deepgram Voice Agent API — native audio-to-audio dialogue (Nova-3 listen, configurable think LLM, Aura-2 speak) over a single WebSocket. The recommended realtime path for kombify reference deployments.",
			License:        "proprietary",
			Capabilities:   []Capability{CapabilityAudioInput, CapabilityRealtimeAudio, CapabilityToolCalling, CapabilitySessionSummary},
