...
// Synthesize implements [Provider] against the Google Cloud Text-to-Speech
// text:synthesize endpoint with the configured API key.
...
// Name implements [Provider]; it returns "google".
func (g *Google) Name() string { return "google" }

// Kind implements [Provider]; Google is a direct cloud provider.
func (g *Google) Kind() ProviderKind { return ProviderKindDirectProvider }
