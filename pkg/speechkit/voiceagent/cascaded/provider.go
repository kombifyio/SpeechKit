...
// The Genkit agent-flow adapter (NewAgentFlowAdapter) lives in the internal
// shim package internal/voiceagent/cascaded so this public package carries no
// Genkit dependency. Embedders supply their own Agent implementation.
