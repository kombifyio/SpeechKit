...
// reminders. Implementations decide where the entries live (SQLite,
// Postgres, file-based JSON, or the in-process scheduler of the skills
// catalog).
