...
- [ ] `speechkit.pages.dev` and the canonical public website domain both serve the current version and the stable `releases/latest/download/SpeechKit-Setup.exe` link after deployment
