...
for root in "${search_roots[@]}"; do
  ...
  while IFS= read -r file; do
    case "$file" in
      ...
      android/keyboard/heliboard/app/src/main/assets/dicts/*) continue ;;
      android/keyboard/heliboard/fastlane/*) continue ;;
      android/keyboard/heliboard/app/build/*) continue ;;
      android/*/build/*|android/build/*) continue ;;
      # Skip binary files
      *.class|*.jar|*.dex|*.apk|*.aab|*.png|*.jpg|*.ico|*.woff2|*.syso|*.dict|*.bin|*.lock) continue ;;
    esac
