...
PREPARE_LLAMA_RUNTIME_SCRIPT="$SCRIPT_DIR/prepare-llama-runtime.ps1"
...
require_path "$PREPARE_LLAMA_RUNTIME_SCRIPT" "llama.cpp runtime prepare script"
...
echo "Bundling local llama.cpp runtime..."
powershell -ExecutionPolicy Bypass -File "$PREPARE_LLAMA_RUNTIME_SCRIPT" -BundleDir "$BUNDLE_DIR" -CacheDir "$PROJECT_DIR/.cache"
