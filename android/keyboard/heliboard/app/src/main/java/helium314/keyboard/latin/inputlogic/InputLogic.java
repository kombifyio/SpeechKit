    ...
    private void handleFunctionalEvent(final Event event, final InputTransaction inputTransaction,
        ...
        switch (keyCode) {
            ...
            case KeyCode.SETTINGS:
                ...
                break;
            case KeyCode.SPEECHKIT_FEATURES:
                KeyboardSwitcher.getInstance().toggleSpeechKitFeatures();
                break;
            case KeyCode.SPEECHKIT_DICTATE:
                // Dictate mode: record, transcribe, insert text
                mLatinIME.onSpeechKitDictate();
                break;
            case KeyCode.SPEECHKIT_ASSIST:
                // Live mode: continuous transcription (same as dictate for now)
                mLatinIME.onSpeechKitAssist();
                break;
