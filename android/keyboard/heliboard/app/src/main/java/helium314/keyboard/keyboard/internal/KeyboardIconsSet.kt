...
//            NAME_PREVIOUS_KEY to                null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.SPEECHKIT_MENU -> R.drawable.ic_speechkit_menu
                    ToolbarKey.DICTATE -> R.drawable.ic_speechkit_dictate
                    ToolbarKey.ASSIST -> R.drawable.ic_speechkit_assist
                })
            }
        } }
