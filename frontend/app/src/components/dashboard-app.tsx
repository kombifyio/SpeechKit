      ...
      <div className="flex flex-shrink-0 items-center gap-3 px-5 pt-4 pb-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-white/40">
            Recent transcriptions and quick notes, sorted by date
          </p>
        </div>
      </div>
    ...
    <div data-testid="transcription-row" className="group flex items-start gap-3 rounded-lg px-2 py-2 transition-colors hover:bg-white/[0.03]">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-1 flex items-center gap-2">
          <span className="rounded bg-white/6 px-1.5 py-0.5 text-[10px] font-medium text-white/40">
            {record.provider}
          </span>
          {record.model ? (
            <span className="rounded bg-sky-500/12 px-1.5 py-0.5 text-[10px] text-sky-200/90">
