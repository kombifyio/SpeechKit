...
const (
	...
	msgUnsupportedModeHotkey = "Use Win+Alt, Ctrl+Win, or Ctrl+Shift with an optional extra key."
	msgDuplicateHotkeys      = "Each mode needs its own two-key base."
	...
	msgHFTokenRequired       = "Please enter a Hugging Face token." //nolint:gosec // not a credential, field name triggers false positive
	msgHFTokenSaved          = "Hugging Face token saved."
	msgHFTokenCleared        = "Hugging Face token cleared."
	msgHFUnavailableBuild    = "Hugging Face is not available in this build."
