...
func Catalog(cfg *config.Config) []Item {
	...
	return []Item{
		// ── Whisper STT local models ─────────────────────────────────────────
		{
			...
			Name:        "Whisper Tiny English (77 MB)",
			Description: "Fastest transcription, English only. Good for low-memory devices.",
			SizeLabel:   "77 MB",
			SizeBytes:   77_704_715,
			Kind:        KindHTTP,
			URL:         "https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-tiny.en.bin",
			License:     "mit",
			Available:   FileIsPresent(filepath.Join(modelsDir, "ggml-tiny.en.bin")),
		},
		{
			ID:          "whisper.ggml-base-en",
			ProfileID:   "stt.local.whispercpp",
			Name:        "Whisper Base English (148 MB)",
			Description: "Best balance of speed and accuracy for English. Recommended for most laptops.",
			SizeLabel:   "148 MB",
			SizeBytes:   148_951_043,
			Kind:        KindHTTP,
			URL:         "https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-base.en.bin",
			License:     "mit",
			Available:   FileIsPresent(filepath.Join(modelsDir, "ggml-base.en.bin")),
			Recommended: true,
		},
		{
			...
			Description: "High accuracy, supports all languages. Default bundle model.",
			SizeLabel:   "466 MB",
