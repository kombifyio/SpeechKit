	...
	return Catalog{
		Profiles: []Profile{
			// --- STT: Local (download required) ---
			{
				...
				ModelID:        "whisper.cpp",
				Source:         "Local",
				Description:    "Offline Windows dictation with Whisper.cpp. Starts with Whisper Small and offers a larger open-source download.",
				License:        "mit",
			...
			// --- Utility LLM: Local (Ollama download) ---
			{
				...
				ModelID:        "gemma4:e4b",
				Source:         "Local (Ollama)",
				Description:    "Local Gemma download for Assist replies, summaries, and shortcut follow-ups.",
				License:        "gemma",
				AllowInference: true,
				Default:        true,
			},
