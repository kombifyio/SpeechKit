...
func defaults() *Config {
	cfg := &Config{
		...
		LocalLLM: LocalLLMConfig{
			...
			IdleStopMinutes: DefaultLocalLLMIdleStopMinutes,
		},
		VPS: VPSConfig{
			Enabled:   false,
		...
		Meeting: MeetingConfig{
			...
			CompactOnStart:          true,
			AlwaysOnTop:             true,
			GenerationProvider:      MeetingProviderLocal,
			BatchMinutes:            5,
			SummaryLanguage:         "auto",
			ScreenshotEnabled:       true,
			ScreenshotHotkey:        DefaultMeetingScreenshotHotkey,
		...
		Providers: ProvidersConfig{
			...
			Cloudflare: CloudflareProviderConfig{
				APITokenEnv:  CloudflareAIGatewayAuthTokenEnv,
				AccountIDEnv: CloudflareAccountIDEnv,
				GatewayIDEnv: CloudflareAIGatewayIDEnv,
				UtilityModel: DefaultCloudflareAIGatewayUtilityModel,
				AssistModel:  DefaultCloudflareAIGatewayAssistModel,
			},
			...
			Foundry: FoundryProviderConfig{
				...
				AuthMode:               FoundryAuthModeAPIKey,
				EntraCredential:        FoundryEntraCredentialAuto,
				AzureCLIProfile:        FoundryAzureCLIProfileShared,
				...
				STTStyle:               DefaultFoundrySTTStyle,
				VoiceLiveModel:         DefaultFoundryVoiceLiveModel,
				VoiceLiveVoice:         DefaultFoundryVoiceLiveVoice,
				VoiceLiveTranscription: DefaultFoundryVoiceLiveTranscription,
			},
		},
